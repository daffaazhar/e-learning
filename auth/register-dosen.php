...
if (isset($_POST["register"])) {
  $result = registrationLecturer($_POST);
  if ($result["status"] > 0) {
      ...
      <form action="" method="POST" class="bg-white w-[30rem] px-8 pt-8 pb-6 rounded-xl shadow-[0_10px_25px_rgba(92,99,105,0.2)]" enctype="multipart/form-data">
        ...
        <div class="mb-3.5">
          <div class="relative h-[50px]">
            <input type="text" name="nip" id="nip" class="form__input" autocomplete="off" placeholder=" " required />
        ...
        <div class="relative mb-3 h-[50px]">
          <select id="dropdown" name="position" class="form__input dropdown" required>
        ...
        <div class="flex justify-center">
          <p class="text-sm text-[#868686]">Sudah punya akun? <a class="font-semibold text-[#2363DE]" href="./login-dosen.php">Login Disini</a></p>
        </div>
      </form>
    </div>
  </div>
