  ...
  <div class="flex justify-center items-center bg-gradient-to-r from-cyan-500 to-blue-500">
    <div class="flex justify-center items-center h-screen">
      <form action="" method="POST" class="bg-white w-96 px-8 pt-8 pb-6 rounded-xl shadow-[0_10px_25px_rgba(92,99,105,0.2)]">
        ...
        <h1 class="mt-2 text-3xl font-bold text-[#34364a] leading-relaxed">Login Mahasiswa.</h1>
        ...
        <div class="flex justify-center">
          <p class="text-sm text-[#868686]">Belum punya akun? <a class="font-semibold text-[#2363DE]" href="./register-mahasiswa.php">Daftar Disini</a></p>
        </div>
      </form>
    </div>
  </div>
